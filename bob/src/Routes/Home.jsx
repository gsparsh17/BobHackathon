    ...
    <div className='bg-orange-50 h-screen mt-12'>
        ...
        <div className='flex pt-24 justify-center gap-x-[4vw]'>
            <div className='my-auto w-1/2 -mt-8'>
                ...
                <br/>
                {/* <br /> */}
                <h4 className='font-serif leading-[2vw] text-[2vw] text-gray-500'>Empower Your Future: Invest with Confidence at BOB</h4>
                <br/>
                ...
                <button className='-z-9 relative -left-[3vw] top-[0.6vw]'><svg class="mt-8 svg-icon search-icon w-[1.5vw] h-[1.5vw]" aria-labelledby="title desc" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.9 19.7"><title id="title">Search Icon</title><desc id="desc">A magnifying glass icon.</desc><g class="search-path" fill="none" stroke="#848F91"><path stroke-linecap="square" d="M18.5 18.3l-5.4-5.4"/><circle cx="8" cy="8" r="7"/></g></svg></button>
            </div>
            <div className=''>
